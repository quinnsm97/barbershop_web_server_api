...
class Appointment(db.Model):
    ...
    appointmentservices = db.relationship("AppointmentService", back_populates="appointment", overlaps="services,appointment")
    services = db.relationship("Service", secondary="appointment_services", back_populates="appointments", overlaps="appointmentservices, appointment,service")
